...
четырех действий (+, –, x, ÷) на основе «малой» конечной арифметики, где задано правило
«+1» и выполняются свойства коммутативности (+,x), ассоциативности (+, x),
дистрибутивности x относительно +, заданы аддитивная единица «a» и
